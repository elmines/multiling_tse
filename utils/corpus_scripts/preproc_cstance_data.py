...
write_rows(os.path.join(out_dir, "zh_cstance_train.csv"), rows[:train_splindex])
write_rows(os.path.join(out_dir, "zh_cstance_val.csv"), rows[train_splindex:val_splindex])
write_rows(os.path.join(out_dir, "zh_cstance_test.csv"), rows[val_splindex:])
